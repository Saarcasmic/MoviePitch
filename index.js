...
const configuration = new Configuration({
  apiKey: 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
})
...
async function fetchImage(title, synopsis) {
  ...
  document.getElementById('output-img-container').innerHTML = `<img src="data:image/png;base64,${imageResponse.data.data[0].b64_json}">`;
  setupInputContainer.innerHTML = `<button id="view-pitch-btn" class="view-pitch-btn">View Pitch</button>`;
  document.getElementById('view-pitch-btn').addEventListener('click', () => {
    document.getElementById('setup-container').style.display = 'none';
    document.getElementById('output-container').style.display = 'flex';
...
// Call the fetchImage function with the title and synopsis parameters
fetchImage('My Movie Title', 'My Movie Synopsis');
